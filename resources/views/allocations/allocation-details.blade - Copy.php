                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="mt-3">                       
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        {{ $allocation->authorized_representative }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        {{ $allocation->other_delivery_instructions }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        @if($allocation->status == 1)
                            ...
                            <hr>
                            <form method="POST" class="mt-3" action="{{ route('allocation-status-update', ['allocation_id' => $allocation->id]) }}">
                                @csrf
