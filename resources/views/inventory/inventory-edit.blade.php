...
<div class="bg-initial-details mt-2 px-4 py-4">
    <div class="row">
            <h5 class="donation-titles">Inventory Details</h5>
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="product_type" id="product_type" value="{{ $inventory->product_type }}" hidden>
                                    @if($inventory->product_type == 1)
                                        Medicine / Vaccine
                                    @elseif ($inventory->product_type == 2)
                                        Promotional Materials
                                    @elseif ($inventory->product_type == 3)
                                        Monetary
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mt-2">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" readonly class="form-control-plaintext" placeholder="unit_cost" name="unit_cost" value="{{ $inventory->unit_cost }}">
                                </div>
                            </div>
                        </div>
                    </div>
